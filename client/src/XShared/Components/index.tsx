...
export const HDivider = styled.div<DividerProps>`
  width: 100%;
  display: block;
  height: 0;
  border-top: ${props=>props.lineHeight??0.1}rem solid ${props=>props.color??"#111111"};
`;


export const VDivider = styled.div<DividerProps>`
  height: 100%;
  width: 0;
  display: block;
  border-left: ${props=>props.lineHeight??0.1}rem solid ${props=>props.color??"#111111"};
`;